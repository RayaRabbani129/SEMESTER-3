...
public class MyInputForm extends JFrame {
    ...
    private JButton buttonTambah; // Tombol baru untuk penambahan
    ...
    private void createButton() {
        ...
        button.addActionListener(multiplyListener);

        // Tombol penambahan (modifikasi sesuai pertanyaan)
    ...
    private void createPanel() {
        ...
        panel.add(bField);
        panel.add(button);
        panel.add(buttonTambah); // Tambah tombol penambahan
        panel.add(cLabel);
        add(panel);
    }
